...
namespace WholesaleRaja.Database
{
    ...
    public partial class WholesaleRajaEntities : DbContext
    {
        public WholesaleRajaEntities()
            : base("name=WholesaleRajaEntities")
        {
        }
        ...
        public virtual DbSet<WSR_City> WSR_City { get; set; }
        public virtual DbSet<WSR_Country> WSR_Country { get; set; }
        public virtual DbSet<WSR_State> WSR_State { get; set; }
        public virtual DbSet<WSR_UserInfo> WSR_UserInfo { get; set; }
        ...
        public virtual int WSR_Delete_And_Add_Roles_To_User(Nullable<System.Guid> userId, string roleIds)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WSR_Delete_And_Add_Roles_To_User", userIdParameter, roleIdsParameter);
        }
    }
}
